 ...
 * @author Jonas
 */
@WebServlet(name = "ChoosenRoomServlet", urlPatterns = {"/ChoosenRoomServlet"})
public class ChoosenRoomServlet extends HttpServlet {
  ...
  /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Room room = Customer.currentCustomer.getCurrentBuilding().getCurrentFloor().getRaeume().get(Integer.parseInt(request.getParameter("room")));
