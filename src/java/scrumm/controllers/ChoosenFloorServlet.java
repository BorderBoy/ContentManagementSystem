 ...
 * @author Jonas
 */
@WebServlet(name = "ChoosenFloorServlet", urlPatterns = {"/ChoosenFloorServlet"})
public class ChoosenFloorServlet extends HttpServlet {
  ...
  /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Floor floor = Customer.currentCustomer.getCurrentBuilding().getEbenen().get(Integer.parseInt(request.getParameter("floor")));
