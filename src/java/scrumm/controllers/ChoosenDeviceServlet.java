 ...
 * @author Uli
 */
@WebServlet(name = "ChoosenDeviceServlet", urlPatterns = {"/ChoosenDeviceServlet"})
public class ChoosenDeviceServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            Device device = Customer.currentCustomer.getCurrentBuilding().getCurrentFloor().getCurrentRoom().getGeraete().get(Integer.parseInt(request.getParameter("device")));
