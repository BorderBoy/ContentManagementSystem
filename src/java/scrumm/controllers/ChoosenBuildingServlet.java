 ...
 * @author Jonas
 */
@WebServlet(name = "ChoosenBuildingServlet", urlPatterns = {"/ChoosenBuildingServlet"})
public class ChoosenBuildingServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Building building = Customer.currentCustomer.getGebaeude().get(Integer.parseInt(request.getParameter("building")));
