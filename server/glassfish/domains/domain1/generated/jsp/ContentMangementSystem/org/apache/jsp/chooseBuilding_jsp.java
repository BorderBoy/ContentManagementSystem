...
public final class chooseBuilding_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<String> list = (ArrayList<String>) request.getAttribute("buildingList");
      ...
      out.write("                    } else {\n");
      out.write("                        document.getElementById(\"message\").innerHTML = \"nix Gebäude\";\n");
      out.write("                        document.getElementById(\"linkMessage\").innerHTML = \"Zurück zum Kunden\";\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("\n");
      out.write("            </script>\n");
