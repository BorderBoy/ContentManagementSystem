...
public final class chooseRoom_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 out.print(" > " + Customer.currentCustomer.getCurrentBuilding().getCurrentFloor().getBezeichnung()); 
      out.write("</a><br>\n");
      out.write("        \n");
      out.write("        <h1>Raum auswählen</h1>\n");
      out.write("        \n");
      out.write("        <form name=\"ChoosenRoomForm\" action=\"ChoosenRoomServlet\">\n");
      out.write("            \n");
      out.write("            <p id=\"message\"></p>\n");
      out.write("            <a href=\"displayFloor.jsp\"><p id=\"linkMessage\"></p></a>\n");
      out.write("            \n");
      out.write("\n");
 ...
 ArrayList<String> list = (ArrayList<String>) request.getAttribute("roomList");
      ...
      out.write("                    } else {\n");
      out.write("                        document.getElementById(\"message\").innerHTML = \"nix Raum\";\n");
      out.write("                        document.getElementById(\"linkMessage\").innerHTML = \"Zurück zum Ebene\";\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("            </script>\n");
      out.write("\n");
