  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (_jspx_page_context) {
        customerListBean = (java.util.ArrayList) _jspx_page_context.getAttribute("customerListBean", PageContext.PAGE_SCOPE);
        if (customerListBean == null){
          customerListBean = new java.util.ArrayList();
          _jspx_page_context.setAttribute("customerListBean", customerListBean, PageContext.PAGE_SCOPE);
        }
      }
      out.write("\n");
      out.write("\n");
